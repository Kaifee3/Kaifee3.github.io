...
db.createView("salaryviews","employees",[
  {
    $project: {
      _id: 0,
      name: 1,
...
//
/*
//to copy the data of shell into another file
mongodump -d lpu -o f:\lpubackup
use mongosh
db.dropeDatabase() this three for mongoshell
exit
mongorestore -d lpu f:\lpubackup\lpu 
 */